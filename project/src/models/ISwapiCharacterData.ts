interface ISwapiCharacterData {
    ...
    films: Array<any>;      // An array of film resource URLs that this person has been in.
    species: Array<any>;    // An array of species resource URLs that this person belongs to.
    starships: Array<any>;  // An array of starship resource URLs that this person has piloted.
    vehicles: Array<any>;   // An array of vehicle resource URLs that this person has piloted.
    url: string;            // the hypermedia URL of this resource.
    created: string;        // the ISO 8601 date format of the time that this resource was created.
    edited: string;         // the ISO 8601 date format of the time that this resource was edited.
}

export default ISwapiCharacterData;
